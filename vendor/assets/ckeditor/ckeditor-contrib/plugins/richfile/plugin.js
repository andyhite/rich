...
(function(){
	...
	CKEDITOR.plugins.add('richfile',
	{
	    ...
	    editor._.insertImagefn = CKEDITOR.tools.addFunction(function(url, id, name, title, display_url){
				this.insertHtml('<span class="fancybox.iframe image-detail pointer" href="'+ url +'"><img src="' + display_url + '" alt="' + title + '" data-rich-file-id="' + id + '" /></span>');
			}, editor);

			editor._.insertFilefn = CKEDITOR.tools.addFunction(function(url, id, name, title){
